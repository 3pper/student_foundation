...
var egor = User(username: "eegorko", age: 22, height: 178, weight: 78, activityLevel: 10)
print("My username is \(egor.username), \(egor.age) year's old, my height is \(egor.height), weight is \(egor.weight) and activity level is \(egor.activityLevel)")
...
// в готовом примере почему-то стоит sefl перед расчетами?? self.feet = meters * 3.28084, не понял почему
// вроде и так все работает, может при расчетах выявиться ошибка, но я не проверял
//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile = Distance(meters: 1600)
print(mile.feet)

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var mile2 = Distance(meters: 5000)
print(mile2.meters)
print(mile2.feet)
