...
struct RunningWorkout {
    ...
    func avarageMileTime() {
        print("Avarage miles per minute is \(distance / (1600 * time))")
    }
}
var distance = RunningWorkout(distance: 35000, time: 200, elevation: 10)
distance.avarageMileTime()
...
var steps = Steps(steps: 9999, goal: 10_000)
steps.takeStep()
