...
struct User {
    ...
    static var currentUser = User(userName: "eegorko", email: "lodpsaf@gmail.com", age: 22)
    
    static func logIn(user: User) {
        currentUser = user
        print("\(user.userName) was log in")
    }
}
 ...
 */
User.logIn(user: User(userName: "gogo", email: "lof", age: 22))
