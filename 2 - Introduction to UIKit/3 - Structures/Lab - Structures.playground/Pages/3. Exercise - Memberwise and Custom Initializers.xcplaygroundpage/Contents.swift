...
let somePlace = GPS(latitude: 51.514004, longitide: 0.125226)
print(somePlace.latitude)
print(somePlace.longitide)
...
var favouriteBook = Book(title: "Ufuf", author: "ffj", pages: 200, price: 200)
print("Price of my book is \(favouriteBook.price)")
/*:
...
var laptop1 = Laptop(screenSize: 100, yearPurchased: 200)
var lapton2 = Laptop(screenSize: 100, yearPurchased: 20)
/*:
...
let height = Height(heightInCentimeters: 100)
...
//    }
//}
//let height2 = Height2(heightInInches: 100)
