...
if let numberOfJun = dictionary["January"] {
    print("January has \(numberOfJun) days")
}
...
let secondDictionary = ["Shapes": shapesArray, "Colors": colorArray]
...
if let last = secondDictionary["Colors"]?.last {
    print(last)
}
