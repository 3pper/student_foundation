...
let newBest = 15125
let congretulations = "Congratulations, \(fullName)! You beat your previous high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
