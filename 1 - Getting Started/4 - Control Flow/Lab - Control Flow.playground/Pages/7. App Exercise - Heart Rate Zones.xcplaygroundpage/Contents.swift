...
case 121...140:
    print("You are in Light zone. Activity in this zone helps improve basics endurence and fat burning.")
case 141...160:
    print("You are in the Moderate zone. Activity in this zone helps improve aerobic fitness.")
case 161...180:
    print("You are in the Hard zone. Activity in this zone increases maximum perfomance capaciti for shorter sessions.")
case 181...200:
