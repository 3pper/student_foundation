 ...
 */
let userInputAge: String = "19"
func checkAge(ageStr: String) -> Int? {
    if let ageInt = Int(ageStr) {
        if ageInt >= 18 {
            print("Welcome!")
        } else {
            print("Sorry, but yoou aren't old enough to use our app")
        }
        return ageInt
    } else {
...
func purshare(item: String) -> Double? {
...
print(purshare(item: "Chips")!)
print(purshare(item: "Donats")as Any)
